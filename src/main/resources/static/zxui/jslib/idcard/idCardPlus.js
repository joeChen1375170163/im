 ...
 * action
 * 
 * 国家数据地址：http://www.mca.gov.cn/article/sj/xzqh/2018/
 * 
 * 引用顺序：
 * <script src="js/province_city_area_code.js"></script>
   <script src="js/util.js"></script>
   <script src="js/area_service.js"></script>
   <script src="js/idCardPlus.js"></script>
 * 使用方式：idCard().info(idcard))
 * 
 * 
